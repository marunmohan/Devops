...
public class UserDb {
	...
	public UserDb(){
		...
		User u1=new User("Arun","Mohan","1234","marunmohan@gmail.com");
		User u2=new User("Arun","Mohan","abcd","marunmohan@outlook.com");
		User u3=new User("Arun","Mohan","1234","marunmohan@hotmail.com");
